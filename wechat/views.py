...
class CustomWeChatView(WeChatView):
    ...
    handlers = [
        HelpOrSubscribeHandler, BookEmptyHandler, ClickHeaderHandler, BookHeaderHandler, CancellHeaderHandler, UnbindOrUnsubscribeHandler, BindAccountHandler,  BookWhatHandler,  GetTicketHandler, CalHandler,
    ]
